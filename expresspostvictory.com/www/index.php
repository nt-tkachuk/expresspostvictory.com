    ...
    <body >
        ...
        <section id="about" class="light-bg wrap">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="info-img-block">
					<img src="img/ImLogo0.jpg" position = "center" class="info-img"/>
				</div>	
            </div></div></div>
        </section>
        ...
        <section>
            ...
            <div class="row" align="center">
                <video id="myVideo" controls="controls" autoplay loop  muted poster="video/img.png">
        ...
        <section>
            <div class="info" align="center">
                <div class="main_contact">
                    <h3>Условия доставки в Украину</h3>
                </div>
                <h4>
                    <?
        ...
        <div class="main_contact2">
            <form method="POST" action="php/letters.php">          
                <div class="col-sm-6 col-md-6 col-xs-12">
                <!--required-->
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email" name="Email" required>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Имя" name="name" required>
                </div></br></br>
                <div class="col-sm-12 col-md-12">
                    <textarea  class="form-control" id="exampleInputPassword1" placeholder="Текст" name="txtarea" required></textarea>
